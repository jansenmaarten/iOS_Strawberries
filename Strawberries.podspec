#
# Be sure to run `pod spec lint Strawberries.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of Strawberries
  #
  #                   * Markdown format.
  ...
  # s.source       = { :svn => 'http://EXAMPLE/Strawberries/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/Strawberries', :revision => '1.0.0' }
